	...
	elandmall.sns = {
			sharePage : function(p){
				...
				if(p.sns == "FB"){			//페이스북
					...
					snsShareUrl = "http://blog.naver.com/openapi/share?serviceCode=share&url="+encodeURIComponent(p.url);
					
				}else if(p.sns == "LN"){	//네이버 라인
					
					snsShareUrl= "http://line.me/R/msg/text/?"+encodeURIComponent(snsText+p.url);
