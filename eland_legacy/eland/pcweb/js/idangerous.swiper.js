...
var Swiper = function (selector, params) {
    ...
    var defaults = {
        ...
        useCSS3Transforms : !($("html").hasClass("safari")),
        // Autoplay
        autoplay: false,
    ...
    /*==================================================
        Swipe Functions
    ====================================================*/
    _this.swipeNext = function (speed, runCallbacks, internal) {
        ...
        swipeToPosition(newPosition, 'next', {speed: speed, runCallbacks: runCallbacks});
        return true;
    };
    _this.swipePrev = function (speed, runCallbacks, internal) {
        if (typeof runCallbacks === 'undefined') runCallbacks = true;
        if (!internal && params.loop) _this.fixLoop();
        if (!internal && params.autoplay) _this.stopAutoplay(true);
        ...
        if (newPosition === currentPosition) return false;
        swipeToPosition(newPosition, 'prev', {speed:speed ,runCallbacks: runCallbacks});
